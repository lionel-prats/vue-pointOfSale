...
<template>
    ...
    >
        ...
        <div class="flex items-center gap-3">
            ...
            >
                <!-- icono "edit" HeroIcons (https://heroicons.com/) (v336) -->
                <svg 
                ...
                <!-- fin icono "edit" HeroIcons (https://heroicons.com/) (v336) -->
            </RouterLink>

            <!-- btn para eliminar uyn producto de la DB (340) -->
            <button
                type="button"
            ...
            <!-- fin btn para eliminar uyn producto de la DB (340) -->
